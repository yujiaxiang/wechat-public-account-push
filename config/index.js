export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxa3d9a66e7af9a4e0",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "530fd58fbd5d2f0b2f0c8cae40df8729",
  ...
  USERS: [
    {
      ...
      id: "oWGr86hfWR0nZpNAL2m1BHAnKoio",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "rGTz7Pb8vjUabNPdE_VuEs9G4iYsH3vFZmze0mvvUZs",
      // 所在省份
      province: "重庆",
      // 所在城市
      city: "渝北",
  ...
  CALLBACK_TEMPLATE_ID: "rGTz7Pb8vjUabNPdE_VuEs9G4iYsH3vFZmze0mvvUZs",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "oWGr86n65H1ti2sHCzRbjJIdI46s",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
